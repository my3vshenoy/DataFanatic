...
x_mean = wine_quality["density"].mean()
y_mean = wine_quality["quality"].mean()
slope = calc_slope(wine_quality["density"], wine_quality["quality"])
intercept_density = y_mean - (slope * x_mean)
...
predicted_quality = wine_quality["density"].apply(predict_y_from_x)
...
within_one = within_percentage(wine_quality["quality"], predicted_y, std_err, 1)
within_two = within_percentage(wine_quality["quality"], predicted_y, std_err, 2)
within_three = within_percentage(wine_quality["quality"], predicted_y, std_err, 3)