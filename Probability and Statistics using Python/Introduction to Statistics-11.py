...
survey_responses_map = [survey_scale.index(response) for response in survey_responses]

average_smoking = sum(survey_responses_map)/len(survey_responses_map)
...
male_list = [savings[i] for i in range(0, len(gender)) if gender[i] == "male"]
female_list = [savings[i] for i in range(0, len(gender)) if gender[i] == "female"]
