...
np = food_info["Protein_(g)"]/food_info["Protein_(g)"].max()
food_info["Normalized_Protein"] = np
nf = food_info["Lipid_Tot_(g)"]/food_info["Lipid_Tot_(g)"].max()
food_info["Normalized_Fat"] = nf
